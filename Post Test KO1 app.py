...
database_reaksi = {
    ...
    "Alkohol Sekunder": {
        ...
        "Uji Iodoform": {"hasil": "(+) Endapan Kuning", "alasan": "Menghasilkan iodoform jika struktur alkoholnya berwujud metil karbinol.", "warna_akhir": "#fef08a", "efek": "precipitate"},
        ...
        "Pereaksi Schiff": {"hasil": "(-) Bening", "alasan": "Hanya bereaksi dengan aldehid.", "warna_akhir": "#f8fafc", "efek": "none"}
    },
    "Alkohol Tersier": {
        ...
        "Pereaksi Schiff": {"hasil": "(-) Bening", "alasan": "Hanya untuk uji aldehid.", "warna_akhir": "#f8fafc", "efek": "none"}
    },
    "Aldehid": {
        ...
        "Uji Iodoform": {"hasil": "(-) Bening", "alasan": "Hanya positif untuk asetaldehida spesifik.", "warna_akhir": "#f8fafc", "efek": "none"},
        ...
        "Pereaksi Schiff": {"hasil": "(+) Merah Magenta", "alasan": "Aldehid memulihkan warna fuksin pada pereaksi Schiff.", "warna_akhir": "#d946ef", "efek": "none"}
    },
    "Keton": {
        ...
        "Pereaksi Schiff": {"hasil": "(-) Bening", "alasan": "Keton tidak bereaksi dengan pereaksi Schiff.", "warna_akhir": "#f8fafc", "efek": "none"}
    },
    "Asam Karboksilat": {
        ...
        "Uji Iodoform": {"hasil": "(-) Bening", "alasan": "Tidak membentuk gugus metil keton.", "warna_akhir": "#f8fafc", "efek": "none"},
        ...
        "Pereaksi Schiff": {"hasil": "(-) Bening", "alasan": "Bukan aldehid.", "warna_akhir": "#f8fafc", "efek": "none"}
    },
    "Alkana": {
        ...
        "Pereaksi Schiff": {"hasil": "(-) Bening", "alasan": "Senyawa inert.", "warna_akhir": "#f8fafc", "efek": "none"}
    }
}
...
urutan_pereaksi = [
    ...
    "Hidroksilamin", "Pereaksi Schiff"
]

# ================= UI UTAMA =================
st.title("⚙️ Mesin Auto-Analyzer 2D")
st.write("Sistem ini akan mereaksikan sampel secara berurutan. **Sesuai SOP, jika satu uji spesifik memberikan hasil (-) / tidak bereaksi, maka pengujian akan langsung dihentikan** dan tidak dilanjutkan ke tahap berikutnya.")
    ...
    if senyawa == "-- Pilih Senyawa --":
        ...
        for i, pereaksi in enumerate(urutan_pereaksi):
            ...
            if "(+)" in res["hasil"]:
                ...
                # LOGIKA BERHENTI (BREAK) KETIKA HASIL NEGATIF
                log_container.warning("🛑 **Reaksi Dihentikan:** Karena spesifik uji menghasilkan reaksi negatif, maka proses ke reagen selanjutnya tidak diteruskan sesuai prosedur analisis.")
                break # Menghentikan loop
            
        # Selesai
        status_placeholder.empty()
        tube_placeholder.markdown(render_tube("0%", "transparent", "none"), unsafe_allow_html=True)
        st.info(f"✅ **Analisis selesai.**")
